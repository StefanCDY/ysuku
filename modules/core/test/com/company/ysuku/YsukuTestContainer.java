...
public class YsukuTestContainer extends TestContainer {

    public YsukuTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/ysuku/app.properties",
    ...
    public static class Common extends YsukuTestContainer {

        public static final YsukuTestContainer.Common INSTANCE = new YsukuTestContainer.Common();
